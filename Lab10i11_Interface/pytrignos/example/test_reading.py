...
if __name__ == "__main__":
    ...
    trigno_sensors.add_sensors(sensors_mode='EMG', sensors_ids=(1,), sensors_labels=('EMG1',), host='150.254.46.37')
    # trigno_sensors.add_sensors(sensors_mode='ORIENTATION', sensors_ids=(1,), sensors_labels=('ORIENTATION1',), host='150.254.46.37')
